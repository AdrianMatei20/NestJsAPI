...
export class AuthController {
  ...
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'invalid user id or expired or invalid token' })
  @ApiResponse({ status: HttpStatus.INTERNAL_SERVER_ERROR, description: 'internal server error' })
  async verifyUser(
    @Param('id') id: string,
  ...
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'invalid user id, expired or invalid token or passwords don\'t match' })
  @ApiResponse({ status: HttpStatus.INTERNAL_SERVER_ERROR, description: 'internal server error' })
